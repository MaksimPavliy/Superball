...
{
    [Serializable]
    public class InMobiMediationSettings : MediationSetupManager
    {
        public override Mediations type => Mediations.INMOBI_NETWORK;
        ...
        public override string folder => "InMobi";
    }
}
#endif