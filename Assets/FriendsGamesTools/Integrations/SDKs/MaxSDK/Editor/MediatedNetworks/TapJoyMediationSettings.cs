...
{
    [Serializable]
    public class TapJoyMediationSettings : MediationSetupManager
    {
        public override Mediations type => Mediations.TAPJOY_NETWORK;
        ...
        public override string folder => "Tapjoy";
    }
}
#endif