...
{
    public class ECS_TRAJECTORIES_HowTo : HowToModule
    {
        public override string forWhat => "to create preset trajectories visually, move entities on them, make queues";
        protected override void OnHowToGUI()
        {
            TrajectoriesView.ShowOnGUI("Put this to your top UI canvas for isometric content");
            Trajectory3DView.ShowOnGUI("Create trajectories by adding this script to some go",
        ...
        ExampleScript Trajectory3DView = new ExampleScript("Trajectory3DView");
