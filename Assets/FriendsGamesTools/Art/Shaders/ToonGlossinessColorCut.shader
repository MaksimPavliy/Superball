Shader "Custom/ToonGlossinessColorCut" {
	Properties{
		...
		SubShader{
			...
			LOD 200
			CGPROGRAM
			#pragma surface surf CelShaded alphatest:_Cutoff addshadow
			#pragma target 3.0
			...
			void surf(Input IN, inout SurfaceOutputCelShaded o) {
				...
				fixed4 c = lerp(_Color, texColor, texColor.a);  //tex2D(_MainTex, IN.uv_MainTex) * _Color;
				o.Albedo = c.rgb;
				o.Alpha = c.a;
