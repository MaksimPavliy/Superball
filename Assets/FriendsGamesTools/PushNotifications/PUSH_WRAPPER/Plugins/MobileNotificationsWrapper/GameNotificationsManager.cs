...
using System.IO;
using System.Linq;
#if UNITY_ANDROID && PUSH_WRAPPER
using Unity.Notifications.Android;
using NotificationSamples.Android;
#elif UNITY_IOS && PUSH_WRAPPER
...
namespace NotificationSamples
{
	...
	public class GameNotificationsManager : MonoBehaviour
	{
		...
		private void OnForegrounding()
		{
			...
			IList<IGameNotification> loaded;
			try {
				loaded = Serializer?.Deserialize(Platform);
			} catch {
				Debug.Log("cant load notifications");
				return;
            }
